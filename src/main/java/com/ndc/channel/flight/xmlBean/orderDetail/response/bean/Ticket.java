 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.iata.org/IATA/2015/00/2018.2/IATA_OrderViewRS}ConnectedDocNumber"/>
...
public class Ticket {
    ...
    @XmlElement(name = "ConnectedDocNumber", namespace = "http://www.iata.org/IATA/2015/00/2018.2/IATA_OrderViewRS", required = true)
    protected String connectedDocNumber;
     ...
     *     
     */
    public String getConnectedDocNumber() {
        return connectedDocNumber;
    }

    /**
     * 设置connectedDocNumber属性的值。
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setConnectedDocNumber(String value) {
