 ...
 *         &lt;element ref="{http://www.iata.org/IATA/2015/00/2018.2/IATA_OrderChangeRQ}DatedOperatingLegID"/>
 *         &lt;element ref="{http://www.iata.org/IATA/2015/00/2018.2/IATA_OrderChangeRQ}Dep"/>
 *         &lt;element ref="{http://www.iata.org/IATA/2015/00/2018.2/IATA_OrderChangeRQ}IATAAircraftType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "DatedOperatingLeg", namespace = "http://www.iata.org/IATA/2015/00/2018.2/IATA_OrderChangeRQ")
public class DatedOperatingLeg {
    ...
    @XmlElement(name = "DatedOperatingLegID", namespace = "http://www.iata.org/IATA/2015/00/2018.2/IATA_OrderChangeRQ", required = true)
    ...
    protected Dep dep;
    @XmlElement(name = "IATAAircraftType", namespace = "http://www.iata.org/IATA/2015/00/2018.2/IATA_OrderChangeRQ", required = true)
    protected IATAAircraftType iataAircraftType;
    ...
    /**
     * 获取iataAircraftType属性的值。
     * 
     * @return
     *     possible object is
     *     {@link IATAAircraftType }
     *     
     */
    public IATAAircraftType getIATAAircraftType() {
        return iataAircraftType;
    }

    /**
     * 设置iataAircraftType属性的值。
     * 
     * @param value
     *     allowed object is
     *     {@link IATAAircraftType }
     *     
     */
    public void setIATAAircraftType(IATAAircraftType value) {
