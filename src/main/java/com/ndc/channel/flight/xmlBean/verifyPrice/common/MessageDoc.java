...
@XmlRootElement(name = "MessageDoc", namespace = "http://www.iata.org/IATA/2015/00/2018.2/IATA_OfferPriceRQ")
public class MessageDoc {

    @XmlElement(name = "Name", namespace = "http://www.iata.org/IATA/2015/00/2018.2/IATA_OfferPriceRQ", required = true)
    protected String name;
    @XmlElement(name = "RefVersionNumber", namespace = "http://www.iata.org/IATA/2015/00/2018.2/IATA_OfferPriceRQ", required = true)
    protected String refVersionNumber;

    public MessageDoc() {
        this.name = "NDC_FLIGHT_OFFER_PRICE";
