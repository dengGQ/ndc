 ...
 *         &lt;element ref="{http://www.iata.org/IATA/2015/00/2018.2/IATA_AirShoppingRS}CarrierAircraftType"/>
 *         &lt;element ref="{http://www.iata.org/IATA/2015/00/2018.2/IATA_AirShoppingRS}DatedOperatingLegID"/>
...
@XmlRootElement(name = "DatedOperatingLeg", namespace = "http://www.iata.org/IATA/2015/00/2018.2/IATA_AirShoppingRS")
public class DatedOperatingLeg {
    ...
    @XmlElement(name = "CarrierAircraftType", namespace = "http://www.iata.org/IATA/2015/00/2018.2/IATA_AirShoppingRS", required = true)
    protected CarrierAircraftType carrierAircraftType;
    @XmlElement(name = "DatedOperatingLegID", namespace = "http://www.iata.org/IATA/2015/00/2018.2/IATA_AirShoppingRS", required = true)
    ...
    protected Dep dep;
    @XmlElement(name = "OnGroundDuration", namespace = "http://www.iata.org/IATA/2015/00/2018.2/IATA_AirShoppingRS", required = false)
    protected String onGroundDuration;
    ...
    public String getOnGroundDuration() {
        return onGroundDuration;
    }

    public void setOnGroundDuration(String onGroundDuration) {
